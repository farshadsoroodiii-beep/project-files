...
class SiteSectionQuery extends BaseModel {
    ...
    /*==============================================
        ...
        - Lock the site section row.
        - Prevent concurrent Display Location
          reconciliation from modifying the same
          section simultaneously.

        IMPORTANT:

        - Must receive the active transaction
          connection.

        - Uses SELECT ... FOR UPDATE.

        - The lock remains active until the
          surrounding transaction COMMIT or
          ROLLBACK.
    ==============================================*/
