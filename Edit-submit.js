...
const CarsEditSubmit = (() => {
    ...
    async function submit(event, options = {}) {
        ...
        /*==================================================
            DISPLAY LOCATIONS PENDING SELECTION GUARD
        ==================================================

            A checked Display Location may still be pending
            placement selection.

            Example:

                ☑ SUV
                Page/Card not selected yet

            In this state the Location is intentionally NOT
            written into DisplayLocationsState because the
            assignment is incomplete.

            Submit must NOT silently ignore that selection.

            DisplayLocations UI connector is responsible for
            detecting pending selections.

            Submit only consumes the connector result.

            Submit does NOT inspect Display Locations DOM.
        ==================================================*/
