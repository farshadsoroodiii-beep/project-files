...
/*==================================================
    COMPLETE EDIT SAVE USE CASE V4
    ...
    - All Complete Edit domains participate in the
        ...
        try {
            ...
            await BaseModel.transaction(
                ...
                async (connection) => {
                    ...
                    /*==========================================
                        VALIDATE DISPLAY LOCATION POSITION CONFLICTS
                    ==========================================*/

                    const displayLocationConflicts =
                    ...
                    if (
                        displayLocationConflicts.length
                    ) {

                        throw createError(

                            'One or more Display Location positions are already occupied by another car.',
                    ...
                    await CarDisplayLocation.replaceForCar(
                    ...
                    if (
                        finalDisplayLocations.length !==
                        resolvedDisplayLocations.length
                    ) {
                    ...
                    const expectedDisplayLocationKeys =
                        new Set(
                            ...
                            resolvedDisplayLocations.map(
                                assignment =>
                                    `${assignment.section_id}:${assignment.sort_order}`
                            )
